    ...
    <section className="relative overflow-hidden py-60" style={{ backgroundColor: '#135bfb' }}>
      ...
      <div className="container mx-auto px-4 z-20 relative">
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <Button className="bg-[#2786ff] text-white px-8 py-3 text-base font-semibold rounded-md transition hover:bg-white hover:text-[#135bfb]" style={{ pointerEvents: 'auto' }}>
              Our Services
            </Button>
            <Button variant="outline" className="border-white text-[#135bfb] px-8 py-3 text-base font-semibold rounded-md hover:bg-[#135bfb] hover:text-white transition" style={{ pointerEvents: 'auto' }}>
              Get in Touch
            </Button>
          </div>
        </div>
